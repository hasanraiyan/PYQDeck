...
const markdownStyles = StyleSheet.create({
    ...
    heading1: { fontSize: 22, fontWeight: 'bold', color: COLORS.primary, marginBottom: 5, marginTop: 10 },
    heading2: { fontSize: 20, fontWeight: 'bold', color: COLORS.primary, marginBottom: 5, marginTop: 8 },
